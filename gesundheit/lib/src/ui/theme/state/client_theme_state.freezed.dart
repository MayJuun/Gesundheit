    ...
    return _then(_value.copyWith(
      data: null == data
          ...
          : data // ignore: cast_nullable_to_non_nullable
              as ThemeData,
      clientColorScheme: null == clientColorScheme
...
class _$_ClientThemeState implements _ClientThemeState {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.clientColorScheme, clientColorScheme) ||
                other.clientColorScheme == clientColorScheme) &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, data, clientColorScheme,
      themeMode, isDark, versionNumber, isFirstLoad, isWideMode);
